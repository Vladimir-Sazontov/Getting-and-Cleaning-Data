...
## It was a dicussionable question on the forum about extraction of these variables,
## and a gentleman from TA declared that it is not principal for evaluation.
